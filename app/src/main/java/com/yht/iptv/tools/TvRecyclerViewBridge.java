 ...
 */
public class TvRecyclerViewBridge extends EffectNoDrawBridge {
        ...
        mAnimatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                if (getNewAnimatorListener() != null)
                    getNewAnimatorListener().onAnimationStart(TvRecyclerViewBridge.this, focusView, animation);
            }
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (getNewAnimatorListener() != null)
                    getNewAnimatorListener().onAnimationEnd(TvRecyclerViewBridge.this, focusView, animation);
            }
