...
public class UpdateDialog extends AppCompatDialog implements View.OnClickListener {
    ...
    public UpdateDialog(Context context, IDialogListener onClickListener) {
        super(context, R.style.MyDialogDefine);
        this.onClickListener = onClickListener;
    }

    public UpdateDialog(Context context, IDialogListener onClickListener, String content, String confirm) {
        super(context, R.style.MyDialogDefine);
        this.onClickListener = onClickListener;
